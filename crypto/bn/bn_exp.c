...
/******rsa_final*********************************/
#ifdef EXTRA_RSA_FINAL

#include "/home/nx2/rsa_final_new/include/rsa_final_c.h"
...
{
    int dmax=a->dmax;
    BN_WORD_C *bn_rr, *bn_a, *bn_p, *bn_m;
    bn_rr=BN_WORD_C_new(0,dmax);
    bn_a=BN_WORD_C_new(0,dmax);
    bn_p=BN_WORD_C_new(0,dmax);
    bn_m=BN_WORD_C_new(0,dmax);

    BN_WORD_C_openssl_transform(a, bn_a);
    BN_WORD_C_openssl_transform(p, bn_p);
    BN_WORD_C_openssl_transform(m, bn_m);

    BN_mod_exp_cuda_c(bn_rr,bn_a,bn_p,bn_m);
    openssl_BN_WORD_C_transform(rr, bn_rr);

    BN_WORD_C_free(bn_rr);
    BN_WORD_C_free(bn_a);
    BN_WORD_C_free(bn_p);
    BN_WORD_C_free(bn_m);
